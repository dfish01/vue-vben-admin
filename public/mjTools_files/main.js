...
, Pi = class {
  ...
  async getImageInfo(a, h, p) {
      return {
        "image_url": "https://image.gfish.top/image/attachments/1134013816187928607/1150651783144816721/meztiran_85874_demon_queen_in_the_sea_wallpaper_in_the_style_of_c9f27617-44f3-4ce4-9596-2bcd9d3de29c.png",
        "image_num": 1,
        "job_id": "c9f27617-44f3-4ce4-9596-2bcd9d3de29c",
        "child_job_id": "15c12980-2a94-4ba4-8cde-a4194a65ddf9",
        "prompt": "demon queen in the sea wallpaper, in the style of green and black, xu beihong, colorful turbulence, anime art, loose and fluid forms, environmental portraiture, high-keyed palette,, --chaos 0 --s 406 --stop 100 --niji 5 --ar 16:9",
        "has_prompt_enabled": true
    }
...
var ur = class {
  ...
  async setup() {
      //定制化字段
      console.log("-----");
      const regionObj = window.parent.varyRegionForm.value;
      this.prompt = regionObj.card.prompt,
      this.input_job_id = 1,
      this.input_index = 1,
      this.has_prompt_enabled = true,
      this.imageURL = regionObj.card.resultImage,
      ...
      this.checkerboardImage = new ce.Raster("./mjTools_files/checkerboard.png"),
  ...
  loadImageAsync(a) {
    console.log("loadImageAsync11  url:" + a);
  ...
  forPageLoadAsync() {
      console.log("forPageLoadAsync 1");
      return new Promise(a=>{
          console.log("forPageLoadAsync 2");
